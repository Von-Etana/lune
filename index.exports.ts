...
export { default as BlockchainWalletUI } from './components/BlockchainWalletUI';
...
export type { CredentialWallet, VerifiableCredential, VerificationResult } from './services/blockchainWalletService';
