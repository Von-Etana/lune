...
import { Search, Play, Award, MapPin, CheckCircle, Sliders, FileText, ShieldCheck, XCircle, Plus, Sparkles, Briefcase, GraduationCap, Filter, Building2, DollarSign, Globe, Clock, Trash2, Mail, User, X, ExternalLink, Copy } from 'lucide-react';
