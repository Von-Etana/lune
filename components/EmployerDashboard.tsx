...
import { Search, Play, Award, MapPin, CheckCircle, Sliders, FileText, ShieldCheck, XCircle, Plus, Sparkles, Briefcase, GraduationCap, Filter, Building2, DollarSign, Globe, Clock, Trash2, Mail, User, X, ExternalLink, Copy, Loader, ChevronDown, BarChart3, Settings, Edit2, Save } from 'lucide-react';
                           ...
                           >
                              ...
                              <button
                                 onClick={() => {
                                    ...
                                    const matchedCandidate = candidates.find(c => c.name === verifyResult.candidateName);
                                    if (matchedCandidate) {
                                       setShowVerification(false);
                                       openProfile(matchedCandidate, 'credentials');
                                    } else {
                                       toast.info('Full passport view not available for this candidate');
                                    }
                                 }}
         ...
         <AnimatePresence>
            {showProfileSettings && (
               <motion.div
                  ...
                  exit={{ opacity: 0 }}
                  className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4 backdrop-blur-sm"
                  onClick={() => { setShowProfileSettings(false); setIsEditingProfile(false); }}
               >
                  <motion.div
                     initial={{ scale: 0.95, opacity: 0 }}
                     animate={{ scale: 1, opacity: 1 }}
                  ...
                  >
                     <div className="bg-gradient-to-r from-slate-800 to-slate-900 p-6 text-white flex justify-between items-start">
                        <div>
                           ...
                           <p className="text-slate-300 text-sm">Manage your company profile</p>
                        </div>
                        <button onClick={() => { setShowProfileSettings(false); setIsEditingProfile(false); }} className="text-slate-300 hover:text-white">
                           <XCircle />
                        </button>
                     </div>
                        ...
                        {isEditingProfile ? (
                           <>
                              ...
                              <div className="flex gap-3 pt-2">
                                 <button
                                    onClick={() => { setIsEditingProfile(false); setProfileForm({ ...employerProfile }); }}
                              ...
                              <div className="space-y-3">
                                 <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
                                    ...
                                    <div>
                                       ...
                                       <p className="font-semibold text-gray-900">{employerProfile.companyName}</p>
                                    </div>
                                 </div>
                                 <div className="grid grid-cols-2 gap-3">
                                    <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
                                       ...
                                       <div>
                                          ...
                                          <p className="font-medium text-gray-800">{employerProfile.industry}</p>
                                       </div>
                                    </div>
                                    <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
                                       ...
                                       <div>
                                          ...
                                          <p className="font-medium text-gray-800">{employerProfile.companySize}</p>
                                       </div>
                                    </div>
                                 </div>
                                 <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
                                    ...
                                    <div>
                                       ...
                                       <a href={employerProfile.website} target="_blank" rel="noopener noreferrer" className="font-medium text-blue-600 hover:underline">{employerProfile.website}</a>
                                    </div>
                                 </div>
                                 <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
                                    ...
                                    <div>
                                       ...
                                       <p className="font-medium text-gray-800">{employerProfile.location}</p>
                                    </div>
                                 </div>
                                 <div className="p-3 bg-gray-50 rounded-xl">
                                    <p className="text-xs text-gray-500 mb-1">About</p>
                                    <p className="text-sm text-gray-700">{employerProfile.about}</p>
                                 </div>
                              </div>
                              <button
                              ...
                              <div className="flex justify-between items-start">
                                 ...
                                 <div className="flex gap-2 items-center">
                                    ...
                                    {(viewingCandidate as any).passportId && (
                                       <button
                                          onClick={() => toast.info(`Passport: ${(viewingCandidate as any).passportId}`)}
