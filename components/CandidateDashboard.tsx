               ...
               <div className="lg:col-span-4 space-y-6">
                  ...
                  <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 text-center relative overflow-hidden">
                     ...
                     <div className="relative z-10 mt-12">
                        <div className="w-24 h-24 bg-white rounded-full p-1 mx-auto shadow-lg mb-4">
                        ...
                        {Object.entries(candidate.skills).map(([skill, score]) => (
                           <div key={skill}>
                              ...
                              <div className="w-full bg-gray-100 rounded-full h-2 overflow-hidden shadow-inner">
                                 <div
                                    className={`h-full rounded-full transition-all duration-1000 ease-out ${(score as number) >= 80 ? 'bg-gradient-to-r from-teal-500 to-emerald-400' : 'bg-gradient-to-r from-orange-400 to-orange-500'}`}
                                    style={{ width: `${score}%` }}
                                 ></div>
                              </div>
                           </div>
                                 ...
                                 <div className="flex flex-wrap gap-2">
                                    {skills.map(skill => (
                                       <button
                                          ...
                                          className="btn-bounce btn-ripple px-3 py-1.5 bg-gray-50 border border-gray-200 rounded-full text-xs font-medium text-gray-600 hover:bg-black hover:text-white hover:border-black transition"
                                       >
                                          {skill}
                                       </button>
                                    ))}
               ...
               <div className="lg:col-span-8">
                  ...
                  <div className="flex gap-6 mb-6 border-b border-gray-200 pb-1">
                     ...
                     >
                        ...
                        {activeTab === 'interview' && <div className="absolute bottom-0 left-0 w-full h-0.5 bg-indigo-600 rounded-t-full"></div>}
                     </button>
                  </div>
                  ...
                  {activeTab === 'overview' && (
                     <>
                                 ...
                                 <div className="flex-1">
                                    ...
                                    {!recommendations ? (
                                       <button
                                          ...
                                          className="btn-bounce btn-ripple bg-white text-indigo-900 px-6 py-3 rounded-lg font-bold hover:bg-indigo-50 transition flex items-center gap-2 shadow-md disabled:opacity-80"
                                       >
                                       ...
                                       <div className="inline-flex items-center gap-2 bg-green-500/20 text-green-300 px-4 py-2 rounded-lg border border-green-500/30 backdrop-blur-sm font-medium">
                              ...
                              <div>
                                 ...
                                 <div className="grid grid-cols-1 gap-6">
                                    {recommendations.jobs.map((job, i) => (
                                       <div key={i} className="bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 group overflow-hidden">
                                          <div className="p-6">
                                             ...
                                             <div className="flex items-center gap-3 pt-4 border-t border-gray-100">
                                                <button className="flex-1 bg-black text-white py-3 rounded-xl text-sm font-bold hover:bg-gray-800 transition transform active:scale-[0.98]">
                                                   Apply Now
                                                </button>
                                                <button className="px-4 py-3 border border-gray-200 rounded-xl hover:bg-gray-50 text-gray-600 transition">
                                                   <Bookmark size={20} />
                                                </button>
                                             </div>
                                          </div>
                              ...
                              <div>
                                 ...
                                 <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                                    {recommendations.certifications.map((cert, i) => (
                                       <div key={i} className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-lg transition-all duration-300 flex flex-col h-full group">
                        ...
                        {!recommendations && (
                           <div className="text-center py-16 px-4 rounded-3xl border-2 border-dashed border-gray-200 bg-gray-50/50">
