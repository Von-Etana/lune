                              ...
                              <div className="flex flex-wrap gap-2">
                                 {skills.map(skill => (
                                    <button
                                       ...
                                       className="px-3 py-1.5 bg-gray-50 border border-gray-200 rounded-full text-xs font-medium text-gray-600 hover:bg-black hover:text-white hover:border-black transition active:scale-95"
                                    >
                                       {skill}
                                    </button>
                                 ))}
                      ...
                      <div className="flex items-start gap-4">
                         ...
                         <div className="flex-1">
                            ...
                            {!recommendations ? (
                               ...
                               >
                                  {loadingRecommendations ? <Loader className="animate-spin" size={18} /> : <Sparkles size={18} />}
