...
import { mintSkillPassport, getPassportShareLink } from '../services/pwrService';
...
export const CandidateDashboard: React.FC<CandidateDashboardProps> = ({ candidate, onStartAssessment, onLogout, onUpdateProfile, onOpenVideoAnalyzer, onStartTour }) => {
   ...
   const handleSharePassport = () => {
      ...
      const shareLink = getPassportShareLink(passportId);
                     ...
                     <div className="relative z-10">
                        <div className="flex items-center gap-3 mb-4">
                           ...
                           <div>
                              ...
                              <p className="text-orange-100 text-xs">Blockchain-verified credentials</p>
                           </div>
                        </div>
                        ...
                        {passportData || (candidate as any).passportId ? (
                           ...
                           <div className="space-y-3">
                              <p className="text-orange-100 text-sm">
                                 Mint your verified skills to the blockchain and share with employers.
                              </p>
                              <motion.button
                                 whileHover={{ scale: 1.02 }}
                                 whileTap={{ scale: 0.98 }}
