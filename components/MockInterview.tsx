  ...
  return (
    <div className="max-w-4xl mx-auto animate-in fade-in duration-500">
      ...
      <div className="bg-gradient-to-r from-slate-900 to-slate-800 text-white p-8 rounded-3xl mb-8 relative overflow-hidden shadow-xl">
        <div className="absolute top-0 right-0 w-64 h-64 bg-teal rounded-full mix-blend-overlay filter blur-3xl opacity-20 -translate-y-1/2 translate-x-1/2"></div>
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-2">
             <div className="bg-white/10 p-2 rounded-lg backdrop-blur-sm">
                <MessageSquare size={24} className="text-teal-300"/>
             </div>
        ...
        <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 text-center py-16">
           ...
           <div className="flex justify-center gap-4 mb-8">
              <button 
                ...
                className={`px-6 py-3 rounded-xl font-bold border-2 transition ${topic === 'behavioral' ? 'border-indigo-600 bg-indigo-50 text-indigo-700' : 'border-gray-200 hover:border-gray-300 text-gray-600'}`}
              >
                Behavioral
              </button>
              <button 
                onClick={() => setTopic('technical')}
                className={`px-6 py-3 rounded-xl font-bold border-2 transition ${topic === 'technical' ? 'border-indigo-600 bg-indigo-50 text-indigo-700' : 'border-gray-200 hover:border-gray-300 text-gray-600'}`}
              >
                Technical
              </button>
           </div>
           ...
           <button 
             ...
             disabled={loading}
             className="bg-black text-white px-10 py-4 rounded-xl font-bold text-lg hover:bg-gray-800 transition shadow-lg shadow-indigo-500/20 flex items-center gap-2 mx-auto"
           >
      ...
      {(mode === 'interview' || mode === 'feedback') && (
        <div className="space-y-6">
           ...
           <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 relative">
              ...
              <div className="flex items-start gap-4">
                 <div className="w-12 h-12 bg-black rounded-full flex items-center justify-center flex-shrink-0">
                    <div className="w-6 h-6 bg-teal rounded-full animate-pulse"></div>
                 </div>
           ...
           {mode === 'interview' && (
              <div className="bg-white p-6 rounded-3xl shadow-lg border border-indigo-100 animate-in slide-in-from-bottom-4">
                 ...
                 <textarea
                    ...
                    className="w-full h-40 p-4 rounded-xl bg-gray-50 border border-gray-200 focus:ring-2 focus:ring-indigo-500 focus:border-transparent outline-none resize-none font-sans text-slate-700 leading-relaxed mb-4"
                 />
                 ...
                 <div className="flex justify-end">
                    <button 
                      ...
                      className="bg-teal text-white px-8 py-3 rounded-xl font-bold hover:bg-teal-700 transition flex items-center gap-2 shadow-md disabled:opacity-50"
                    >
              ...
              <div className="bg-white rounded-3xl shadow-lg border border-gray-100 overflow-hidden animate-in slide-in-from-bottom-4">
                 <div className="bg-indigo-50 p-6 border-b border-indigo-100">
                    <h3 className="font-bold text-xl text-indigo-900 flex items-center gap-2">
                       <Sparkles className="text-indigo-600" /> Analysis Results
                    </h3>
                 </div>
