      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-16 flex-1">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center lg:pl-12">
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-center lg:justify-start mb-12">
              <button 
                ...
                className="bg-black text-white px-8 py-4 rounded-xl font-semibold text-lg hover:bg-gray-800 transition w-full sm:w-auto shadow-xl shadow-orange/10"
              >
                Get Started
              </button>
              <button className="px-8 py-4 rounded-xl font-semibold text-lg border border-slate-300 hover:bg-white transition w-full sm:w-auto">
                Book Demo
              </button>
            </div>
        ...
        <div id="features" className="mt-24 md:mt-32 scroll-mt-24">
           ...
           <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm hover:shadow-md transition group hover:-translate-y-1 duration-300">
                 <div className="w-12 h-12 bg-purple-100 rounded-2xl flex items-center justify-center mb-6 text-purple-600 group-hover:scale-110 transition">
                    <Zap size={24} />
                 </div>
              ...
              <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm hover:shadow-md transition group hover:-translate-y-1 duration-300">
                 <div className="w-12 h-12 bg-blue-100 rounded-2xl flex items-center justify-center mb-6 text-blue-600 group-hover:scale-110 transition">
                    <Lock size={24} />
                 </div>
              ...
              <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm hover:shadow-md transition group hover:-translate-y-1 duration-300">
                 <div className="w-12 h-12 bg-green-100 rounded-2xl flex items-center justify-center mb-6 text-green-600 group-hover:scale-110 transition">
                    <Globe size={24} />
                 </div>
